    ...
    public partial class AddIdentityAndFeatures : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtistFavorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtistFavorites_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumFavorites", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumFavorites_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumFavorites_AlbumId",
                table: "AlbumFavorites",
                column: "AlbumId");

            migrationBuilder.CreateIndex(
                name: "IX_AlbumFavorites_UserId_AlbumId",
                table: "AlbumFavorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistFavorites_ArtistId",
                table: "ArtistFavorites",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtistFavorites_UserId_ArtistId",
                table: "ArtistFavorites",
